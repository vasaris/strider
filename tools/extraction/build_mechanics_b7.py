...
CARDS = [
    ...
    },
    {
        ...
        "notes": "Владелец Бдительности Ока. ⚠ ГЕЙТ-2a №1 (ф.170): референт «знака» в ВЗОР ОКА — "
                 "источник пишет «выпадает знак» (не «Око»); по глоссарию книги «знак» = знак успеха ✶ "
                 "(«знак Ока» — 0 употреблений, Око всегда «Око»), но кость не указана и эффект "
                 "существен — закодировано буквально по источнику, подтвердить референт по скану/"
                 "оригиналу, не подменять «Око» из памяти. Знаменитое оружие/броня → treasure (B8, "
                 "форвард-реф). Баллы Тени → shadow.bally_teni (B6). Таблица состава (0/1/2/3) — "
                 "подтверждающий 2b.",
    },
    {
