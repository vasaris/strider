...
## F4 — training_cost разрешён по скану (2026-06-24)
| Карта | Фолио | Что сверено |
|---|---|---|
| struktura_fazy_bratstva (training_cost) | 119 | таблица СТОИМОСТЬ ОБУЧЕНИЯ: C1 «уровень навыка/умения» = пиктограммные пипсы 1–6 (текст-слой роняет), C2 «уровень Доблести/Мудрости» = none,2,3,4,5,6, C3 «цена» = 4/8/12/20/26/30; привязка уровень↔цена построчно. 18 чисел, 0 расхождений; негативный контроль: текст-слой-поток `[4,2,8,3,12,4,20,5,26,6,30]` = реконструкция из строк (reproducible: `tools/extraction/verify_gate2b_training_cost.py`). Снят авторский ⚠GATE-2b-флаг карты; F4-open-item закрыт. |
